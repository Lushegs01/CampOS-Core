...
import {
  Users, TrendingUp, TrendingDown, Calendar, Activity, GraduationCap,
...
const quickActions = [
  { label: "Add Student", icon: Plus, color: "bg-emerald-500", href: "/dashboard/admin/students" },
  { label: "Send Notification", icon: Activity, color: "bg-blue-500", href: "/dashboard/admin/notifications" },
  { label: "Generate Report", icon: BarChart3, color: "bg-violet-500", href: "/dashboard/admin/analytics" },
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Overview of your institution</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          change={stats.housingOccupancyChange}
          changeLabel="vs last month"
          icon={Building2}
          color="bg-amber-500"
        />
