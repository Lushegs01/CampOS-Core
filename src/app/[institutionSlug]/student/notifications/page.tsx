...
const initialNotifications = [
  { id: "1", title: "Welcome to CampOS", message: "Your account has been verified successfully.", type: "success" as const, source: "core", isRead: false, createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24) },
  { id: "2", title: "Course Registration Open", message: "Registration for 2024/2025 session is now open.", type: "info" as const, source: "unireg", isRead: false, createdAt: new Date(Date.now() - 1000 * 60 * 60 * 5) },
  { id: "3", title: "Housing Payment Due", message: "Your hostel fee payment is due in 3 days.", type: "warning" as const, source: "funaabnb", isRead: true, createdAt: new Date(Date.now() - 1000 * 60 * 60 * 12) },
  { id: "4", title: "Attendance Recorded", message: "Your attendance for CSC 301 was recorded.", type: "success" as const, source: "scanmark", isRead: false, createdAt: new Date(Date.now() - 1000 * 60 * 30) },
];
